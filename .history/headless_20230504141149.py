...
def grabProjections():
    ...
    #getPro.find_element_by_xpath('//a[@download="DFF_MLB_cheatsheet_2023-05-04.csv"]').click()
    #getPro.find_element_by_xpath('//span[@class="hidden-sm"]').click()
    #getPro.find_element_by_link_text("CSV").click()
    getPro.find_element_by_css_selector('a href target._blank').click()
chromeOptions = Options()
chromeOptions.headless = True
